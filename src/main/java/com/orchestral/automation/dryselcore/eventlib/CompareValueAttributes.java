...
public class CompareValueAttributes extends TestEvent {

	public CompareValueAttributes() {
	}
	...
	public void fire(final WebDriver webDriver, final String xPath, final String value) throws ElementNotEnabledException {
		...
		Assert.assertEquals("The expected value of the attribute named 'value' is NOT equal to : " + value, value,

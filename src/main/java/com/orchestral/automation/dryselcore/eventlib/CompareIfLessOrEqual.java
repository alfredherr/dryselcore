...
public class CompareIfLessOrEqual extends TestEvent {

	public CompareIfLessOrEqual() {
	}
	...
	public void fire(final WebDriver webDriver, final String xPath, final String value) throws ElementNotEnabledException {
		...
		Assert.assertTrue("The expected value " + value + " is not less than or equal to the current value "

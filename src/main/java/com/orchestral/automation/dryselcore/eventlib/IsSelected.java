...
public class IsSelected extends TestEvent {
	...
	public void fire(final WebDriver webDriver, final String xPath, final String value) throws ElementNotEnabledException {
		final WebElement webElement = webDriver.findElement(By.xpath(xPath + "/ancestor::div[1]"));
		Assert.assertTrue("The expected element (one of the three radio buttons) is NOT selected.",
				webElement.getAttribute("class").contains("radio-container selected"));
	}

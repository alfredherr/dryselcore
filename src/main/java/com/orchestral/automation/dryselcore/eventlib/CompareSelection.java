...
public class CompareSelection extends TestEvent {
	...
	public void fire(final WebDriver webDriver, final String xPath, final String value) throws ElementNotEnabledException {
		...
		Assert.assertEquals("The expected item '" + value + "' is not selected in the drop-down box.", value,
				new Select(webElement).getFirstSelectedOption().getText());
	}

...
public class SwitchToApplicationContent extends TestEvent {

	public SwitchToApplicationContent() {
	}

	@Override
	public void fire(final WebDriver webDriver, final String elementID, final String value) {
		webDriver.switchTo().defaultContent();
		webDriver.switchTo().frame(webDriver.findElement(By.id("ConcertoContext")));
		webDriver.switchTo().frame(webDriver.findElement(By.id(elementID)));
	}
}

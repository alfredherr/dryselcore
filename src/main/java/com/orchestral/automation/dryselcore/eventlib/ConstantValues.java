...
public final class ConstantValues {
	...
	private static long timeoutInSeconds = 5000;
	private static long pollingTimeInSeconds = 1;

	public static long getPollingTimeInSeconds() {
		return pollingTimeInSeconds;
	}

	public static long getTimeoutInSeconds() {
		return ConstantValues.timeoutInSeconds;
	}
}
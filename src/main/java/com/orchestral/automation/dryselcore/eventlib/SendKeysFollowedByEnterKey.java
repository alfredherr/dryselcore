...
public class SendKeysFollowedByEnterKey extends TestEvent {

	public SendKeysFollowedByEnterKey() {
	}
	...
	public void fire(final WebDriver webDriver, final String xPath, final String value)
		...
		try {
			webElement.clear(); // clear existing contents.
		} catch (final Exception e) {

		} finally {
			webElement.sendKeys("\b"); // hack : send backslash, for the reason
										// stated in

...
public class ContainsIcon extends TestEvent {
	...
	public void fire(final WebDriver webDriver, final String xPath, final String value) throws ElementNotEnabledException {
		final WebElement iconElement = webDriver.findElement(By.xpath(xPath + "/i"));
		Assert.assertTrue("The web element does NOT contain expected icon.",
				iconElement.getAttribute("class").contains(value));
	}

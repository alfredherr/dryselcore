...
public class CompareIfGreaterOrEqual extends TestEvent {

	public CompareIfGreaterOrEqual() {
	}
	...
	public void fire(final WebDriver webDriver, final String xPath, final String value) throws ElementNotEnabledException {
		...
		final Double currentValue = Double.parseDouble(formElement.getText());
		Assert.assertTrue("The expected value " + value + " is not greater than or equal to the current value "
				+ currentValue.toString(), currentValue >= Double.parseDouble(value));
	}
